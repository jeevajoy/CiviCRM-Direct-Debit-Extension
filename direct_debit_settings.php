...
define( 'CIVICRM_DIRECT_DEBIT_BATCH_REPORT_URL',   'civicrm/report/instance/35?reset=1' );

// Activity - New DD SignUp 
define( 'CIVICRM_DIRECT_DEBIT_NEW_DIRECT_DEBIT_SIGNUP_ACTIVITY_ID', '58' );

// Activity - DD Awaiting Signed Declaration
define( 'CIVICRM_DIRECT_DEBIT_AWAITING_SIGNED_DECLARARION_ACTIVITY_ID', '59' );

// Activity - DD Authorization Required
define( 'CIVICRM_DIRECT_DEBIT_AUTHORISAION_REQUIRED_ACTIVITY_ID', '60' );

// Activity - DD First Collection
define( 'CIVICRM_DIRECT_DEBIT_FIRST_COLLECTION_ACTIVITY_ID', '61' );

// Activity - DD Standard Payment
define( 'CIVICRM_DIRECT_DEBIT_STANDARD_PAYMENT_ACTIVITY_ID', '62' );

// Activity - DD Final Payment
define( 'CIVICRM_DIRECT_DEBIT_FINAL_PAYMENT_ACTIVITY_ID', '63' );
...
//DD Setup Letter template ID
define( 'CIVICRM_DIRECT_DEBIT_SETUP_LETTER_TEMPLATE_ID', '60' );
